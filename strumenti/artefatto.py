...
# Dentro un artefatto il service worker non serve e non aiuta: la pagina non
# sta alla radice di un dominio suo e `sw.js` non e' fra i file pubblicati,
# quindi la registrazione fallisce a ogni apertura. Prima qui c'era una
# sostituzione che rimpiazzava una stringa con se stessa, e la registrazione
# partiva lo stesso. Si spegne all'origine, con una variabile che js/app.js
# controlla prima di registrare.
SPEGNI_SW = '<script>window.READDA_SENZA_SW = true;</script>\n\n'
...
def main():
    ...
    open(fuori, 'w', encoding='utf-8').write(TESTA + SPEGNI_SW + corpo + '\n')
